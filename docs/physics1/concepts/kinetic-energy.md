...
Kinetic Energy is introduced in lecture12_rotation, lecture13_rolling_torque_angular_momentum, lecture11_collision_and_impulse, lecture20_oscillations_simple_harmonic_motion, lecture22_waves_traverse_wave_wave_equation, lecture24_waves_sound_waves, lecture29_distribution_of_molecular_speed, lecture28_ideal_gas, lecture14_review_midterm, lecture16_gravitation_newton_superposition, lecture17_gravitation_kepler_einstein, lecture19_fluids_continuity_bernoulli, lecture08_kinetic_energy_and_work, lecture09_potential_energy_and_conservation_of_energy. The formulation helps bridge intuitive motion and mathematical description.
...
Derivation varies across lectures. Core steps are scattered across lecture12_rotation, lecture13_rolling_torque_angular_momentum, lecture11_collision_and_impulse, lecture20_oscillations_simple_harmonic_motion, lecture22_waves_traverse_wave_wave_equation, lecture24_waves_sound_waves, lecture29_distribution_of_molecular_speed, lecture28_ideal_gas, lecture14_review_midterm, lecture16_gravitation_newton_superposition, lecture17_gravitation_kepler_einstein, lecture19_fluids_continuity_bernoulli, lecture08_kinetic_energy_and_work, lecture09_potential_energy_and_conservation_of_energy.
...
SC133
Lecture 22
Waves—Traverse Wave, The Wave Equation
SC133 - Lecture 22
Lecturer: Pakorn Wongwaitayakornkul

Types of Waves
1. Mechanical waves: water waves, sound waves, and seismic waves.
Newton's law + material medium.
2. Electromagnetic waves: visible and ultraviolet light, radio and
television waves, microwaves, x rays, and radar waves. No medium.
Same speed c = 299 792 458 m/s.
3. Matter waves: common in technology. Associated with electrons,
protons, and other fundamental particles, and even atoms and
molecules.

Transverse Waves
A wave sent along a stretched, taut
Pulse
string is the simplest mechanical wave.
A single pulse is sent along a stretched
string.
A distortion in the string's shape moves
along the string at some velocity 

Transverse Waves
If move hand up and down in SHM, a
Sinusoidal
...
SoundWaves
·Sound waves is defined roughly as any longitudinal wave
Examples:
· Seismic prospecting teams use such waves to probe Earth's crust for oil.
Ships carry sound-ranging gear (sonar) to detect underwater obstacles.
· Submarines use sound waves to stalk other submarines
Ultrasound can be used to explore the soft tissues of an animal or
human body.

Sound Waves
Point S represents a tiny sound source,
called a point source.
-Wavefronts
Wavefronts are surfaces over which the
oscillations due to the sound wave have
the same value.
S
Ray
Rays are directed lines perpendicular to
the wavefronts that indicate the direction
Ray
of travel of the wavefronts.

The Speed of Sound
The speed of any mechanical wave depends on both
1. an inertial property of the medium (to s
SC133
Physics for Engineering 1
SC133
Lecture 29
...
2. Where in your lectures is this concept used? (lecture12_rotation, lecture13_rolling_torque_angular_momentum, lecture11_collision_and_impulse, lecture20_oscillations_simple_harmonic_motion, lecture22_waves_traverse_wave_wave_equation, lecture24_waves_sound_waves, lecture29_distribution_of_molecular_speed, lecture28_ideal_gas, lecture14_review_midterm, lecture16_gravitation_newton_superposition, lecture17_gravitation_kepler_einstein, lecture19_fluids_continuity_bernoulli, lecture08_kinetic_energy_and_work, lecture09_potential_energy_and_conservation_of_energy)
